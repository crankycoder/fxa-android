...
public class OAuthDialog extends Dialog {
    private static final String LOG_TAG = LoggerUtil.makeLogTag(OAuthDialog.class);
    ...
    public OAuthDialog(Context context, String sign_in_url, String appCallback, String[] scopes, String AppKey) {
        ...
        mUrl = sign_in_url + "/v1/authorization?action=signin"
                + "&client_id=" + AppKey
    ...
    private class ContentViewer {
        ...
        private final OAuthDialog myCallback;

        ContentViewer(OAuthDialog callback) {
            myCallback = callback;
        }
        @SuppressWarnings("unused")
